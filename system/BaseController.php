...
class BaseController{
	...
	function __construct(){
		...
		$this->file_upload_settings['attachment'] = array(
			...
			"filesize" => "3",
			"returnfullpath" => false,
			"filenameprefix" => "Client_",
			"uploadDir" => "uploads/files/client/"
		);
		...
		$this->file_upload_settings['attachment'] = array(
			...
			"filesize" => "3",
			"returnfullpath" => false,
			"filenameprefix" => "Vente_",
			"uploadDir" => "uploads/files/vente/"
		);
		...
		$this->file_upload_settings['attachment'] = array(
			...
			"filesize" => "3",
			"returnfullpath" => false,
			"filenameprefix" => "Versement_",
			"uploadDir" => "uploads/files/versement/"
		);
