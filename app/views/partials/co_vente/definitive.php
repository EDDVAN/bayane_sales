...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="list"  data-display-type="table" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container-fluid">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Vente Archive</h4>
                </div>
                <div class="col-sm-3 ">
                    <?php if($can_add){ ?>
                ...
                <div class="row ">
                    <div class="col-md-12 comp-grid">
                        ...
                        <div  class=" animated fadeIn page-content">
                            <div id="co_vente-definitive-records">
                                    ...
                                    <table class="table  table-striped table-sm text-left">
                                        <thead class="table-header bg-primary text-light">
                                            <tr>
                                                ...
                                                <th  class="td-id_produit"> Produit</th>
                                                <th  class="td-id_dossier"> Dossier</th>
                                                <th  class="td-date"> Date</th>
                                                <th  class="td-promotion"> Promotion</th>
                                                <th  class="td-prix_vente"> Vente</th>
                                        ...
                                        <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                            ...
                                            <tr>
                                                ...
                                                <td class="td-id_dossier"><a href="<?php print_link("co_dossier_client/list") ?>"><?php echo $data['id_dossier']; ?></a></td>
