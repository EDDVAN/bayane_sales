...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="view"  data-display-type="table" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">View  V Vente</h4>
                </div>
            </div>
        </div>
    </div>
                            ...
                            <table class="table table-hover table-borderless table-striped">
                                ...
                                <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                    ...
                                    <tr  class="td-id_consistance">
                                        ...
                                        <td class="value"> <?php echo $data['id_consistance']; ?></td>
                                    </tr>
                                    <tr  class="td-superficie">
                                        <th class="title"> Superficie: </th>
                                        <td class="value"> <?php echo $data['superficie']; ?></td>
                                    </tr>
                                    <tr  class="td-recettes">
                                        <th class="title"> Recettes: </th>
                                        <td class="value"> <?php echo $data['recettes']; ?></td>
                                    </tr>
                                </tbody>
                                <!-- Table Body End -->
                            </table>
