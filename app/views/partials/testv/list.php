...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="list"  data-display-type="table" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container-fluid">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Testv</h4>
                </div>
                <div class="col-sm-4 ">
                    <form  class="search" action="<?php print_link('testv'); ?>" method="get">
                            ...
                            <nav class="page-header-breadcrumbs mt-2" aria-label="breadcrumb">
                                <ul class="breadcrumb m-0 p-1">
                                    ...
                                    <li class="breadcrumb-item">
                                        <a class="text-decoration-none" href="<?php print_link('testv'); ?>">
                                    ...
                                    <table class="table  table-striped table-sm text-left">
                                        ...
                                        <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                            ...
                                            <tr>
                                                ...
                                                <td class="td-id_dossier"> <?php echo $data['id_dossier']; ?></td>
                                                <td class="td-id_produit"> <?php echo $data['id_produit']; ?></td>
                                                ...
                                                <td class="td-condition_vente"> <?php echo $data['condition_vente']; ?></td>
                                                <td class="td-statut"> <?php echo $data['statut']; ?></td>
                                                ...
                                                <td class="td-datecre"> <?php echo $data['datecre']; ?></td>
                                                <td class="td-par"> <?php echo $data['par']; ?></td>
                                                ...
                                                <td class="td-id_vendeur"> <?php echo $data['id_vendeur']; ?></td>
                                                <td class="td-count"> <?php echo $data['count']; ?></td>
                                            </tr>
                                            <?php 
                                            }
                                            ?>
