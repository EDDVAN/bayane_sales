...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="list"  data-display-type="table" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container-fluid">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Versement</h4>
                </div>
                <div class="col-sm-3 ">
                    <?php if($can_add){ ?>
                    <a  class="btn btn btn-primary my-1" href="<?php print_link("". isset($_GET['id_recette']) ? (!empty($_GET['id_recette']) ? "co_versement/add?id_recette=" . $_GET['id_recette'] : "co_versement/add") : "co_versement/add" ."") ?>">
                ...
                <div class="col-sm-4 ">
                    <form  class="search" action="<?php print_link('co_versement'); ?>" method="get">
                            ...
                            <nav class="page-header-breadcrumbs mt-2" aria-label="breadcrumb">
                                <ul class="breadcrumb m-0 p-1">
                                    ...
                                    <li class="breadcrumb-item">
                                        <a class="text-decoration-none" href="<?php print_link('co_versement'); ?>">
                ...
                <div class="row ">
                    <div class="col-md-12 comp-grid">
                        ...
                        <div  class=" animated fadeIn page-content">
                            <div id="co_versement-list-records">
                                <div id="page-report-body" class="table-responsive">
                                    <table class="table  table-striped table-sm text-left">
                                        <thead class="table-header bg-primary text-light">
                                            <tr>
                                                <th class="td-btn"></th>
                                                <th  class="td-co_recette_id_vente"> Vente</th>
                                                <th  class="td-id_recette"> Recette</th>
                                                <th  class="td-id_versement"> Versement</th>
                                                <th  class="td-date_versement"> Date Versement</th>
                                                <th  class="td-date_valeur"> Date Valeur</th>
                                                <th  class="td-CIN"> Cin</th>
                                        ...
                                        <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                            ...
                                            <tr>
                                                <td class="page-list-action td-btn">
                                                    <div class="dropdown" >
                                                        ...
                                                        <ul class="dropdown-menu">
                                                            <?php if($can_view){ ?>
                                                            <a class="dropdown-item" href="<?php print_link("co_versement/view/$rec_id"); ?>">
                                                                <i class="material-icons">visibility</i> View 
                                                            </a>
                                                            <?php } ?>
                                                            <?php if($can_edit){ ?>
                                                            <a class="dropdown-item" href="<?php print_link("co_versement/edit/$rec_id"); ?>">
                                                                <i class="material-icons">edit</i> Edit
                                                            </a>
                                                            <?php } ?>
                                                            <?php if($can_delete){ ?>
                                                            <a  class="dropdown-item record-delete-btn" href="<?php print_link("co_versement/delete/$rec_id/?csrf_token=$csrf_token&redirect=$current_page"); ?>" data-prompt-msg="Are you sure you want to delete this record?" data-display-style="modal">
                                                ...
                                                <td class="td-co_recette_id_vente">
                                                    <span <?php if($can_edit){ ?> data-value="<?php echo $data['co_recette_id_vente']; ?>" 
                                                        ...
                                                        <?php echo $data['co_recette_id_vente']; ?> 
                                                    </span>
                                                </td>
                                                <td class="td-id_recette">
                                                ...
                                                <td class="td-id_versement"> <?php echo $data['id_versement']; ?></td>
                                                <td class="td-date_versement">
                                        ...
                                        <div class="row justify-content-center">    
                                            <div class="col-md-auto justify-content-center">    
                                                <div class="p-3 d-flex justify-content-between">    
                                                    <?php if($can_delete){ ?>
                                                    <button data-prompt-msg="Are you sure you want to delete these records?" data-display-style="modal" data-url="<?php print_link("co_versement/delete/{sel_ids}/?csrf_token=$csrf_token&redirect=$current_page"); ?>" class="btn btn-sm btn-danger btn-delete-selected d-none">
